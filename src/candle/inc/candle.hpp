...
class Heikin_Ashi
{
    private:
        ...
        /**
         * @brief Corresponding standard Candle for Heikin Ashi candle
         */
        Candle candle;
        ...
        /**
         * @brief Heikin Ashi open previous price
         */
        double open_previous;

        /**
         * @brief Heikin Ashi close previous price
         */
        double close_previous;

        /**
         * @brief Absolute price change
         */
        double change_absolute;
    ...
    public:
        ...
        Heikin_Ashi(
            ...
            double close_prev,
            double open_prev
        ) : candle(candle), open_previous(open_prev),
        ...
        /**
         * @brief Set the candle object
         * 
         * @param can Candle
         */
        void set_candle(Candle &can) { this->candle = candle; }
        ...
        ) 
        {
            this->set = true;
            this->candle = can;
            this->close_previous = close_prev;
            this->open_previous = open_prev;
